IF OBJECT_ID('ReportingDB.dbo.NewEventCube_FactCheckIns','U') IS NOT NULL
  DROP TABLE ReportingDB.dbo.NewEventCube_FactCheckIns
...
INTO ReportingDB.dbo.NewEventCube_FactCheckIns
