IF OBJECT_ID('ReportingDB.dbo.NewEventCube_FactComments','U') IS NOT NULL
  DROP TABLE ReportingDB.dbo.NewEventCube_FactComments
...
INTO ReportingDB.dbo.NewEventCube_FactComments
FROM Ratings.dbo.UserCheckInComments S
